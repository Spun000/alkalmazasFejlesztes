...
@Validated
@Tag(name = "addResult", description = "the addResult API")
public interface AddResultApi {
    ...
    /**
     * POST /addResult : Add a new result for the runner and race
     *
    ...
    default ResponseEntity<Void> addResult(
        @Parameter(name = "result", description = "", required = true) @Valid @RequestBody List<@Valid Result> result
    ) {
