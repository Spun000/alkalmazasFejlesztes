...
@Validated
@Tag(name = "addRunner", description = "the addRunner API")
public interface AddRunnerApi {
    ...
    /**
     * POST /addRunner : Add a new runner
     *
    ...
    default ResponseEntity<Void> addRunner(
        @Parameter(name = "runner", description = "", required = true) @Valid @RequestBody Runner runner
    ) {
